...
const GoogleIcon: React.FC<GoogleIconProps> = ({ width = 24, height = 24, ...props }) => {
  return (
    <Svg
      width={width}
      height={height}
    ...
    >
      <Path
        ...
        5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657
        C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,
        4,24c0,11.045,8.955,20,20,20c11.045,0,
        20-8.955,20-20C44,22.659,43.862,21.35,
        43.611,20.083z"
      />
      <Path
        fill="#FF3D00"
        ...
        6.053,29.268,4,24,4C16.318,4,9.656,
        8.337,6.306,14.691z"
      />
      <Path
        fill="#4CAF50"
        ...
        35.091,26.715,36,24,36c-5.202,0-9.619,
        -3.317-11.283-7.946l-6.522,5.025C9.505,
